...
const AskAgentCommands = memo(() => {
  ...
  // Check if branding matches the query
  const lowercaseBrandingName = BRANDING_NAME.toLowerCase();
  const showLobeAI = !mentionQuery || lowercaseBrandingName.includes(mentionQuery);
